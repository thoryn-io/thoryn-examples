...
**Generated:** 2026-09-17T05:32:44.576Z — by the Playwright reporter (e2e/lib/e2e-results-reporter.mjs).
...
|------|--------|----------|
| full Path-B journey signs a verified user in against the sandbox issuer, with the login carrying the recipe's brand | ✅ passed | 22.1s |
...
| Key | Value |
|-----|-------|
| Issuer | examples.hub.stg.thoryn.org/brand-signin-35186065185-1 |
| Relying party | http://127.0.0.1:8471 |
| Identity host | https://identity.stg.thoryn.org |

## Links

- [CI run](https://github.com/thoryn-io/thoryn-examples/actions/runs/35186065185)
