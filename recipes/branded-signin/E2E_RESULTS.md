...
**Generated:** 2026-09-26T05:31:58.532Z — by the Playwright reporter (e2e/lib/e2e-results-reporter.mjs).
...
|------|--------|----------|
| full Path-B journey signs a verified user in against the sandbox issuer, with the login carrying the recipe's brand | ✅ passed | 23.4s |
...
| Key | Value |
|-----|-------|
| Issuer | examples.auth.stg.thoryn.org/ci-branded-signin |
| Relying party | http://127.0.0.1:8471 |
| Identity host | https://examples.auth.stg.thoryn.org/id |

## Links

- [CI run](https://github.com/thoryn-io/thoryn-examples/actions/runs/36220996211)
